...
class AdvancedTopo(Topo):
    ...
    def build(self, **_opts):
        ...
        self.addLink(r1, h1, intfName1='r1-eth5', params1={'ip': '10.1.1.254/24'}, intfName2='h1-eth0', params2={'ip': '10.1.1.1/24'})
        self.addLink(r3, h3, intfName1='r3-eth4', params1={'ip': '10.3.3.254/24'}, intfName2='h3-eth1', params2={'ip': '10.3.3.1/24'})
        self.addLink(r3, h4, intfName1='r3-eth5', params1={'ip': '10.4.4.254/24'}, intfName2='h4-eth0', params2={'ip': '10.4.4.1/24'})
        self.addLink(r2, h5, intfName1='r2-eth5', params1={'ip': '10.5.5.254/24'}, intfName2='h5-eth0', params2={'ip': '10.5.5.1/24'})
        self.addLink(r4, h6, intfName1='r4-eth5', params1={'ip': '10.6.6.254/24'}, intfName2='h6-eth0', params2={'ip': '10.6.6.1/24'})
...
def run():
    ...
    net['r2'].cmd('ip route add 10.13.13.0/24 via 10.13.13.1 metric 8')  # r2 -> r4
    net['r2'].cmd('ip route add 10.15.15.0/24 via 10.15.15.1 metric 4')  # r2 -> r3
